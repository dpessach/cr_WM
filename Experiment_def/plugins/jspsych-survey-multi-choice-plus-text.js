...
jsPsych.plugins['survey-multi-choice'] = (function() {
  ...
  plugin.trial = function(display_element, trial) {
	...
	if (typeof trial.rows == 'undefined') {
      trial.rows = [];
      for (var i = 0; i < trial.questions_t.length; i++) {
        trial.rows.push(1);
      }
    }
 ...
 //////////////////////////////////////////
    ...
    for (var i = 0; i < trial.questions_t.length; i++) {
      ...
      // add question text
      $("#jspsych-survey-text-" + i).append('<p class="jspsych-survey-text">' + trial.questions_t[i] + '</p>');
 ...
 ///////////////////////////////////////////////////
    ...
    $trial_form.submit(function(event) {
	 ...
	 // create object to hold responses_t
		  var question_t_data = {};
	...
	// create object to hold responses
      ...
      var trial_data = {
        "rt": response_time,
        "responses_t": JSON.stringify(question_t_data),
